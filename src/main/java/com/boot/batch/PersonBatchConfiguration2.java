...
public class PersonBatchConfiguration2 {
    @Autowired
    ...
    // tag::jobstep[]
    @Bean
    public Job importUserJobThree(@Qualifier("step3") Step s1,
            JobExecutionListener listener) {
        return jobBuilderFactory.get("importUserJobThree")
    ...
    @Bean
    public Step step3(ItemReader<Person> reader,
